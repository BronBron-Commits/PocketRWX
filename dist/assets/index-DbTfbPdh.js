...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function co(e,t,n){let r=new Float32Array(Ja),i=new K(0,1,0);return new Ni({name:`SphericalGaussianBlur`,defines:{n:Ja,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:fo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lo(){return new Ni({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:fo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(){return new Ni({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fo(),fragmentShader:`
	...
	`}var po=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new yi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
ClumpEnd
ModelEnd
`;document.querySelector(`#sample`).onclick=()=>Ql(eu,`sample.rwx`),document.querySelector(`#exportGlb`).onclick=$l,document.querySelector(`#resetView`).onclick=()=>{Rl.rotation.set(0,0,0),Zl(Rl)},document.querySelector(`#file`).onchange=async e=>{let t=e.target.files[0];t&&Ql(await t.text(),t.name)},addEventListener(`dragover`,e=>{e.preventDefault()}),addEventListener(`drop`,async e=>{e.preventDefault();let t=e.dataTransfer?.files?.[0];t&&Ql(await t.text(),t.name)});var tu=!1,nu=0,ru=0,iu=0;Fl.domElement.addEventListener(`pointerdown`,e=>{tu=!0,nu=e.clientX,ru=e.clientY,Fl.domElement.setPointerCapture?.(e.pointerId)}),Fl.domElement.addEventListener(`pointerup`,e=>{tu=!1,iu=0,Fl.domElement.releasePointerCapture?.(e.pointerId)}),Fl.domElement.addEventListener(`pointercancel`,()=>{tu=!1,iu=0}),Fl.domElement.addEventListener(`pointermove`,e=>{if(!tu)return;let t=e.clientX-nu,n=e.clientY-ru;nu=e.clientX,ru=e.clientY,Rl.rotation.y+=t*.01,Rl.rotation.x+=n*.01}),Fl.domElement.addEventListener(`wheel`,e=>{e.preventDefault(),Pl.position.multiplyScalar(1+e.deltaY*.001),Pl.position.z=Math.max(.05,Math.min(5e3,Pl.position.z))},{passive:!1}),addEventListener(`touchmove`,e=>{if(e.touches.length!==2)return;let t=e.touches[0],n=e.touches[1],r=t.clientX-n.clientX,i=t.clientY-n.clientY,a=Math.sqrt(r*r+i*i);if(iu>0){let e=iu/a;Pl.position.multiplyScalar(e)}iu=a},{passive:!0}),addEventListener(`resize`,()=>{Pl.aspect=innerWidth/innerHeight,Pl.updateProjectionMatrix(),Fl.setSize(innerWidth,innerHeight)}),Ql(eu,`sample.rwx`),Fl.setAnimationLoop(()=>{Fl.render(Nl,Pl)});